...
namespace camerasearch.Client
{
    ...
    /// </summary>
    public class camerasearchViewItemPlugin : ViewItemPlugin
    {

        public camerasearchViewItemPlugin()
        {
        }
        ...
        {
            get { return camerasearchDefinition.camerasearchViewItemPlugin; }
        }
        ...
        {
            return new camerasearchViewItemManager();
        }
