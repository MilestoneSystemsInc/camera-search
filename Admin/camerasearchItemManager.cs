...
namespace camerasearch.Admin
{
    ...
    /// </summary>
    public class camerasearchItemManager : ItemManager
    {
        private camerasearchUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public camerasearchItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new camerasearchUserControl();
        ...
        {
            return new camerasearchAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(camerasearchDefinition.camerasearchPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((camerasearchAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(camerasearchDefinition.camerasearchPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(camerasearchDefinition.camerasearchPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(camerasearchDefinition.camerasearchPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(camerasearchDefinition.camerasearchPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(camerasearchDefinition.camerasearchPluginId, _kind, fqid.ObjectId);
            return item;
        }
